          ...
          >
            {[
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4 group-hover:text-[#6559FF] transition-colors">
                  {service.title}
                </h3>
          ...
          >
            {[
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4 group-hover:text-[#6559FF] transition-colors">
                  {value.title}
                </h3>

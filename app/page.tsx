...
import { Monitor, Settings, FileText, Brain, TestTube, MessageSquare, Code, Users, Cloud } from "lucide-react"
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
            ...
            {["Services", "About", "Contact"].map((item, index) => (
              <motion.div key={item}>
                <Link
                  ...
                  className="hover:text-[#6559FF] transition-colors duration-300 font-medium"
                >
                  <motion.span
          ...
          <div className="px-4 py-6 space-y-4">
            {["Services", "About", "Contact"].map((item, index) => (
              ...
              >
                <Link
                  href={item === "Contact" ? "/contact" : "#"}
                  className="block py-2 text-lg hover:text-[#6559FF] transition-colors"
      ...
      <section className="px-6 bg-black">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center py-20">
          <motion.div
            ...
            className="space-y-8"
          >
            <motion.h2 className="text-4xl lg:text-6xl font-bold leading-tight">
              <AnimatedText text="Tapping Intelligence" className="block" />
              <AnimatedText text="Through Talent." className="block text-[#6559FF]" delay={0.5} />
            </motion.h2>
            <motion.p
            ...
            >
              ...
              Lösungen zu schaffen, die Ihre Geschäftsprozesse revolutionieren. Entdecken Sie, wie die richtige Mischung
              aus menschlichem Talent und intelligenter Automatisierung Ihre Effizienz steigern und nachhaltigen Erfolg
              sichern kann.
            </motion.p>
          </motion.div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <p className="text-[#6559FF] text-sm font-semibold tracking-wider uppercase mb-4">
          ...
          >
            {[
              ...
              <motion.div
                ...
                variants={fadeInUp}
                {...scaleOnHover}
                className="bg-gray-900/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-800 hover:border-[#6559FF]/50 transition-all duration-300 group"
              >
                <motion.div
                  whileHover={{ rotate: 360 }}
                  transition={{ duration: 0.6 }}
                  className="w-16 h-16 bg-[#6559FF]/20 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#6559FF]/30 transition-colors"
                >
                  <service.icon className="w-8 h-8 text-[#6559FF]" />
                </motion.div>
                <h3 className="text-xl font-bold mb-4 group-hover:text-[#6559FF] transition-colors">{service.title}</h3>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {[
              ...
              <motion.div key={value.title} variants={fadeInUp} {...scaleOnHover} className="text-center group">
                <motion.div
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  className="w-20 h-20 bg-[#6559FF]/20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-[#6559FF]/30 transition-colors"
                >
                  <value.icon className="w-10 h-10 text-[#6559FF]" />
                </motion.div>
                <h3 className="text-2xl font-bold mb-4 group-hover:text-[#6559FF] transition-colors">{value.title}</h3>
                <p className="text-gray-300 leading-relaxed max-w-sm mx-auto">{value.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
